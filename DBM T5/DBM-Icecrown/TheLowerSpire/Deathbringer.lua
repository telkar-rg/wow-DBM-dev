...
do
	...
	mod:RegisterOnUpdateHandler(function(self)
		if self.Options.BeastIcons and (DBM:GetRaidRank() > 0 and not (iconsSet == 5 and (instanceSize == 25) or iconsSet == 2 and (instanceSize == 10))) then
...
function mod:SPELL_AURA_APPLIED(args)
	...
	elseif args:IsSpellID(72385, 72441, 72442, 72443) then	-- Boiling Blood
		...
		if (instanceSize == 10) or (((instanceSize == 25)) and #boilingBloodTargets >= 3) then	-- Boiling Blood
