...
L:SetOptionLocalization{
	SetIconOnCollapsingStar	= format("在|c%s%s|r上設定圖標 (|TInterface\\TargetingFrame\\UI-RaidTargetingIcon_%d:16|t -  |TInterface\\TargetingFrame\\UI-RaidTargetingIcon_%d:16|t)", "ffff8040", "崩陷之星", 8, 5),
	-- WarningPhasePunch		= "提示相位拳擊的目標",
	NextCollapsingStar		= format("為下一次|c%s%s|r顯示計時器", "ffff8040", "崩陷之星"),
	...
	warnStarLow				= format("當|c%s%s|r血量低（約25%%）時顯示特別警告", "ffff8040", "崩陷之星")
	-- warnStarLow				= "當崩陷之星血量低 (大約25%)時顯示特別警告"
}

L:SetMiscLocalization{
	YellPull				= "你的行為毫無意義。這場衝突的結果早已計算出來了。不論結局為何，萬神殿仍將收到觀察者的訊息。", 	-- 33995,'zhTW'
	YellKill				= "我曾經看過塵世沉浸在造物者的烈焰之中，眾生連一聲悲泣都無法呼出，就此凋零。整個星系在彈指之間歷經了毀滅與重生。然而在這段歷程之中，我的心卻無法感受到絲毫的...惻隱之念。我‧感‧受‧不‧到。成千上萬的生命就這麼消逝。他們是否擁有與你同樣堅韌的生命?他們是否與你同樣熱愛生命?", 	-- 34000,'zhTW'
	Emote_CollapsingStar	= "%s開始召喚崩陷之星!", 	-- 33244,'zhTW'
	Phase2					= "瞧瞧泰坦造物的能耐吧!", 	-- 33994,'zhTW'
...
L:SetMiscLocalization{
	...
	MobPhase2			= "VX-001",
	MobPhase3			= "空中指揮裝置",
	YellPull			= "我們沒有太多時間，朋友們!你們要幫我測試我最新也是最偉大的創作。在你們改變心意之前，別忘了就是你們把XT-002搞得一團糟，你們欠我一次。",	-- `entry`=-1603179
	YellHardPull			= "為什麼你要做出這種事?難道你沒看見標示上寫著「請勿觸碰這個按鈕!」嗎?現在自爆裝置已經啟動了，我們要怎麼完成測試呢?",	-- `entry`=-1603177
	YellPhase2			= "太好了!絕妙的良好結果!外殼完整度98.9%!幾乎只有一點擦痕!繼續下去。",	-- `entry`=-1603182
	YellPhase3			= "感謝你，朋友們!我們的努力讓我獲得了一些絕佳的資料!現在，我把東西放在哪兒了--噢，在這裡。",	-- entry=-1603186
	YellPhase4			= "初步測試階段完成。現在要玩真的啦!",	-- entry=-1603190
	LootMsg				= "(.+)拾取了物品:.*Hitem:(%d+)",
	
	YellComputerHM		= '自毀程序已展開。',	-- `entry`=-1603248;
	YellComputerTimer10	= '此區域將在十分鐘內自我毀滅。',	-- `entry`=-1603249;
	YellComputerTimer9	= '此區域將在九分鐘內自我毀滅。',	-- `entry`=-1603250;
	YellComputerTimer8	= '此區域將在八分鐘內自我毀滅。',	-- `entry`=-1603251;
	YellComputerTimer7	= '此區域將在七分鐘內自我毀滅。',	-- `entry`=-1603252;
	YellComputerTimer6	= '此區域將在六分鐘內自我毀滅。',	-- `entry`=-1603253;
	YellComputerTimer5	= '此區域將在五分鐘內自我毀滅。',	-- `entry`=-1603254;
	YellComputerTimer4	= '此區域將在四分鐘內自我毀滅。',	-- `entry`=-1603255;
	YellComputerTimer3	= '此區域將在三分鐘內自我毀滅。',	-- `entry`=-1603256;
	YellComputerTimer2	= '此區域將在二分鐘內自我毀滅。',	-- `entry`=-1603257;
	YellComputerTimer1	= '此區域將在一分鐘內自我毀滅。',	-- `entry`=-1603258;
	YellDefeat		= '看來我還是產生了些許計算錯誤。任由我的心智受到囚牢中魔鬼的腐化，棄我的首要職責於不顧。所有的系統看起來都正常運作。報告完畢。',	-- `entry`=-1603194
