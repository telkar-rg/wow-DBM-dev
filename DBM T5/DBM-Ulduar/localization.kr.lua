...
L:SetMiscLocalization{
	...
	MobPhase2 		= "VX-001",
	MobPhase3 		= "공중지휘기",
	YellPull		= "시간이 없어, 친구들! 내가 최근에 만든 기막힌 발명품을 시험하게 도와 주겠지? 자, 마음 바꿀 생각은 말라고. XT-002를 그 꼬락서니로 만들었으니, 너흰 나한테 빚진 셈이란 걸 잊지 마!",	-- `entry`=-1603179
	YellHardPull	= "아니, 대체 왜 그런 짓을 한 게지? \"누르지 마시오.\"라고 쓰인 경고 문구 못 봤나? 자폭 장치를 활성화해 놓으면, 도대체 어떻게 발명품을 시험하지?",	-- `entry`=-1603177
	YellPhase2		= "멋지군! 참으로 경이적인 결과야! 차체 내구도 98.9 퍼센트라! 손상이라고 보기도 어렵지! 계속하자고.",	-- `entry`=-1603182
	YellPhase3		= "고맙다, 친구들! 너희 덕분에 멋진 자료를 좀 얻었어! 자, 그걸 어디 뒀더라... 아, 여기 있군.",	-- entry=-1603186
	YellPhase4		= "예비 시험은 이걸로 끝이다. 자 이제부터가 진짜라고!",	-- entry=-1603190
	LootMsg			= "([^%s]+).*Hitem:(%d+)",
	
	YellComputerHM	= '자폭 절차를 시작합니다.',	-- `entry`=-1603248
	YellComputerTimer10	= '자폭 실행까지 남은 시간은 10분입니다.',	-- `entry`=-1603249
	YellComputerTimer9	= '자폭 실행까지 남은 시간은 09분입니다.',	-- `entry`=-1603250
	YellComputerTimer8	= '자폭 실행까지 남은 시간은 08분입니다.',	-- `entry`=-1603251
	YellComputerTimer7	= '자폭 실행까지 남은 시간은 07분입니다.',	-- `entry`=-1603252
	YellComputerTimer6	= '자폭 실행까지 남은 시간은 06분입니다.',	-- `entry`=-1603253
	YellComputerTimer5	= '자폭 실행까지 남은 시간은 05분입니다.',	-- `entry`=-1603254
	YellComputerTimer4	= '자폭 실행까지 남은 시간은 04분입니다.',	-- `entry`=-1603255
