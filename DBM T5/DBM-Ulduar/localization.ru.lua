...
L:SetOptionLocalization{
	SetIconOnCollapsingStar	= format("Поместите значок на |c%s%s|r (|TInterface\\TargetingFrame\\UI-RaidTargetingIcon_%d:16|t -  |TInterface\\TargetingFrame\\UI-RaidTargetingIcon_%d:16|t)", "ffff8040", "Взрывающаяся звезда", 8, 5),
	-- WarningPhasePunch		= "Объявлять цели заклинания Фазовый удар",
	NextCollapsingStar		= format("Показать обратный отсчет до нового |c%s%s|r", "ffff8040", "Взрывающаяся звезда"),
	...
	warnStarLow				= format("Спец-предупреждение, когда у |c%s%s|r мало здоровья (на ~25%%)", "ffff8040", "Взрывающаяся звезда")
	-- warnStarLow				= "Спец-предупреждение, когда у Вспыхивающей звезды мало здоровья (на ~25%)"
}

L:SetMiscLocalization{
	YellPull				= "Ваши действия нелогичны. Все возможные исходы этой схватки просчитаны. Пантеон получит сообщение от Наблюдателя в любом случае.", 	-- 33995,'ruRU'
	YellKill				= "Я видел миры, охваченные пламенем Творцов. Их жители гибли, не успев издать ни звука. Я был свидетелем того, как галактики рождались и умирали в мгновение ока. И все время я оставался холодным... и безразличным. Я. Не чувствовал. Ничего. Триллионы загубленных судеб. Неужели все они были подобны вам? Неужели все они так же любили жизнь?", 	-- 34000,'ruRU'
	Emote_CollapsingStar	= "%s призывает взрывающиеся звезды!", 	-- 33244,'ruRU'
	Phase2					= "Узрите чудо созидания!", 	-- 33994,'ruRU'
...
L:SetMiscLocalization{
	YellPull 			= "Скоро мы сразимся с главарем этих извергов! Обратите гнев и ненависть против его прислужников!",	-- trinity 34346
...
L:SetTimerLocalization{
	...
	timerCastDeafeningRoar	= "Рык"
	timerNextDeafeningRoar	= format(DBM_CORE_AUTO_TIMER_TEXTS.next, "Рык")
}
