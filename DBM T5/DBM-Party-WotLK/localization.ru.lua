...
L:SetMiscLocalization({
	Pull					= "Великолепно. Сегодня вы в честной борьбе заслужили", 	-- 35544
	AchievementFailed		= ">> ДОСТИЖЕНИЕ ПРОВАЛЕНО: %s получил урон от Взрыва вурдалака <<",
	YellCombatEnd			= "Нет! Я не могу... снова... проиграть." 	-- 35770
	-- YellCombatEnd			= "Мои поздравления, чемпионы. Вы прошли все испытания – как запланированные, так и нет." 	-- 35796
})
...
L:SetMiscLocalization({
	YellPullAlliance	= "Серебряный союз с гордостью представляет своих бойцов, верховный лорд.", 	-- 35259
	YellPullHorde		= "Похитители Солнца с гордостью представляют своих бойцов.", 	-- 35260
	YellPullShort		= "Добро пожаловать, герои. Сегодня вы продемонстрируете свою силу и стойкость перед вашими предводителями и другими участниками турнира.", 	-- 35321
	YellCombatEnd		= "Вы отлично сражались! Следующим испытанием станет битва с одним из членов Авангарда. Вы проверите свои силы в схватке с достойным соперником." 	-- 35541
})
