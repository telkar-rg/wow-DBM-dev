...
DBM = {
	...
	Version = "5.011",
	DisplayVersion = "T5.012 by Telkar@RG", -- the string that is shown as version
	ReleaseRevision = 5012 -- the revision of the latest stable version that is available (for /dbm ver2)
}
