...
DBM_CORE_AUTO_SPEC_WARN_OPTIONS = {
	...
	dispel 		= "Show special warning to dispel/spellsteal $spell:%d",
	interupt	= "Show special warning to interupt $spell:%d",
	you 		= "Show special warning when you are affected by $spell:%d",
	target 		= "Show special warning when someone is affected by $spell:%d",
	close 		= "Show special warning when someone close to you is affected by $spell:%d",
	move 		= "Show special warning when you are affected by $spell:%d",
	run 		= "Show special warning for $spell:%d",
	cast 		= "Show special warning for $spell:%d cast",
	stack 		= "Show special warning for >=%d stacks of $spell:%d"
}
